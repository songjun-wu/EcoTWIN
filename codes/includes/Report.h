...
class Report {
    ...
    ofstream of__age_I;  // Age in Canopy storage [days]
    ofstream of__age_snow;  // Age in Snow depth in [days]
    ofstream of__age_pond;  // Age in Ponding water in [days]
    ofstream of__age_layer1;  // Age in Soil moisture in layer 1 [days]
    ofstream of__age_layer2;  // Age in Soil moisture in layer 2 [days]
    ofstream of__age_layer3;  // Age in Soil moisture in layer 3 [days]
    ofstream of__age_vadose;  // Age in vadose storage [‰]
    ofstream of__age_GW;  // Age in Groundwater storage [days]
    ofstream of__age_chanS;  // Age in Channel storage [days]
    ...
    svector *_age_I_acc;  // Age in Canopy storage [days]
    svector *_age_snow_acc;  // Age in Snow depth in [days]
    svector *_age_pond_acc;  // Age in Ponding water in [days]
    svector *_age_layer1_acc;  // Age in Soil moisture in layer 1 [days]
    svector *_age_layer2_acc;  // Age in Soil moisture in layer 2 [days]
    svector *_age_layer3_acc;  // Age in Soil moisture in layer 3 [days]
    svector *_age_vadose_acc;  // Age in vadose storage [‰]
    svector *_age_GW_acc;  // Age in Groundwater storage [days]
    svector *_age_chanS_acc;  // Age in Channel storage [days]
