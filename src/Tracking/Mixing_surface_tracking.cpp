...
int Basin::Mixing_surface_tracking(Control &ctrl, Atmosphere &atm, Param &par){
    ...
    */
    ...
    if (ctrl.opt_tracking_isotope==1) {
        ...
        Solve_surface_transport(ctrl, atm, par, *_d18o_I, *_d18o_snow, *_d18o_pond, *_d18o_chanS, *_d18o_GW, false); // enrich_flag = false
    ...
    if (ctrl.opt_tracking_age==1) {
        // Mixing snow and irrigation
        Solve_surface_transport(ctrl, atm, par, *_age_I, *_age_snow, *_age_pond, *_age_chanS, *_age_GW, false); // enrich_flag = false
    }
