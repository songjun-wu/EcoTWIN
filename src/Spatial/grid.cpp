...
int svector::multiply_by_double(double weight){
...
int svector::higher_than(svector &sv){
...
int svector::lower_than(svector &sv){
...
int svector::higher_than_double(double minimum){
...
int svector::lower_than_double(double maximum){
