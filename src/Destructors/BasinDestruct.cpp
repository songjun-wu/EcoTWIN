...
int Basin::dtor(Control &ctrl){
  ...
  if (ctrl.opt_drainage == 1){
    if(_drainage_from_soil) delete _drainage_from_soil;
    if(_drainage_from_layer1) delete _drainage_from_layer1;
  ...
  /* Carbon */
  if (ctrl.opt_carbon_sim == 1){
    if(_plant_green_CP) delete _plant_green_CP;
    ...
    if(_doc_layer1) delete _doc_layer1;
    if(_doc_layer2) delete _doc_layer2;
    if(_doc_layer3) delete _doc_layer3;
